...
public class Get {
    ...
    public final class GetCategoryDataset extends AsyncTask<String,Void,ArrayList<InterestPoint>> {
        @Override
        protected ArrayList<InterestPoint> doInBackground(String... category) {
            Log.i(TAG,"Parsing "+category[0]);

            // Xpath Builder
            XPath xpath = XPathFactory.newInstance().newXPath();
            String expression_1 = "/service_requests/request[address_id=" + app_id + " and address = '" + category[0] + "']/description/text()";
            String expression_2 = "/service_requests/request[address_id=" + app_id + " and address = '" + category[0] + "']/address/text()";
            String expression_3 = "/service_requests/request[address_id=" + app_id + " and address = '" + category[0] + "']/lat/text()";
            String expression_4 = "/service_requests/request[address_id=" + app_id + " and address = '" + category[0] + "']/long/text()";
